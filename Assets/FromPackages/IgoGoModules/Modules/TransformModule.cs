...
public class TransformModule : LogicModule
{
    ...
    private void Awake()
    {
        ...
        localTarget = transform.localPosition + targetOffset;
    }
    ...
    private void OnDrawGizmos()
    {
        if(debug)
        {
            ...
            Vector3 targetPos = transform.position + transform.forward * targetOffset.z + transform.right * targetOffset.x + transform.up * targetOffset.y;
